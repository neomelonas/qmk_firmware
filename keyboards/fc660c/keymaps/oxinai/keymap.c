...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT(
        ...
        KC_LCTL,KC_LGUI,KC_LALT,          KC_SPC,                       KC_RALT,KC_RCTL,MO(_MODS),   KC_LEFT,KC_DOWN,KC_RGHT
    ),
  [_FUNC] = LAYOUT(
        KC_GRV, KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,  KC_F6,  KC_F7,  KC_F8,  KC_F9,  KC_F10, KC_F11, KC_F12, KC_DEL,      KC_HOME,
        _______,KC_PGUP,KC_UP,  KC_PGDN,KC_HOME,KC_INS, _______,_______,_______,_______,_______,_______,_______,RESET,       KC_END,
        _______,KC_LEFT,KC_DOWN,KC_RGHT,KC_END, KC_DEL, _______,_______,_______,_______,_______,_______,     _______,
        _______,KC_MPLY,KC_MPRV,KC_MNXT,VRSN,_______,_______,KC_MUTE,KC_VOLD,KC_VOLU,_______,_______,     _______,
...
bool led_update_user(led_t led_state) {
    if(IS_LAYER_ON(_MODS) || IS_LAYER_ON(_FUNC)) {
        togglePin(B5);
    } else {
        togglePin(B5);
    }
