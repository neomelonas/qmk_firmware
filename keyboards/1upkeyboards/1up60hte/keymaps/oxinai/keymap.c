...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_FUNC] = LAYOUT_tsangan(
		KC_GRV,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,    KC_F10,  KC_F11,  KC_F12,  KC_INS, KC_DEL,
        _______,  KC_PGUP, KC_UP,   KC_PGDN, KC_HOME, KC_INS,  RGB_TOG, RGB_MOD, RGB_HUI, RGB_SAI,  RGB_VAI, KC_CAPS, VRSN,    RESET,
        _______,  KC_LEFT, KC_DOWN, KC_RGHT, KC_END,  KC_DEL,  _______, RGB_RMOD,RGB_HUD, RGB_SAD,  RGB_VAD, _______, _______,
        _______,  KC_MPLY, KC_MPRV, KC_MNXT, _______, _______, _______, KC_MUTE, KC_VOLD, KC_VOLU,  _______, KC_UP,   _______,
