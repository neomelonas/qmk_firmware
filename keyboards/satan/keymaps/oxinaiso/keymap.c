...
[_QWERTY] = LAYOUT_60_iso(
  ...
  KC_LCTL, KC_LGUI, KC_LALT,               KC_SPC,                             KC_SPC,  KC_RALT, OSL(_MACROS), CTRLENT),
...
[_MACROS] = LAYOUT_60_iso(
  ...
  _______,_______, _______, _______, _______, VRSN,  _______, _______, OS_MAC, _______, _______, _______,   _______,              //13
