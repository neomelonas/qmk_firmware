...
[_FUNC] = LAYOUT_all(
      ...
      _______,       KC_MPLY,     KC_MPRV,  KC_MNXT,     BL_DEC,    BL_TOGG,    BL_INC,    KC_MUTE,     KC_VOLD,  KC_VOLU,  _______, _______,_______,_______, _______,   _______,   _______,   _______,
      _______,  _______, _______,                  _______,                            _______,   MO(_RGB),  _______,       _______, _______, _______, _______,   _______,          _______),
