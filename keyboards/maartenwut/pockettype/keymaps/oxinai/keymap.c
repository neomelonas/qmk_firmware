...
[_QWERTY] = LAYOUT_ortho_4x12(
  ...
  KC_LCTL,  KC_LGUI,     KC_LALT,     KC_RALT,     LOWER,     KC_SPC,   KC_BSPC,      RAISE,  KC_LEFT,  KC_DOWN,  KC_UP,    KC_MPLY),
...
[_RAISE] = LAYOUT_ortho_4x12(
  _______,  KC_PGUP,     KC_UP,       KC_PGDN,     KC_HOME,     KC_INS,   _______,  KC_PGUP,  KC_UP,    KC_PGDN,  _______,  _______,
  KC_CAPS,  KC_LEFT,     KC_DOWN,     KC_RGHT,     KC_END,      KC_DEL,   _______,  KC_LEFT,  KC_DOWN,  KC_RIGHT, _______,  _______,
