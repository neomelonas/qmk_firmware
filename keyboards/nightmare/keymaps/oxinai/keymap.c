...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_split(/* Base */
        ...
        KC_PGUP, FN_TAB, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOTE, KC_ENTER,
        KC_PGDN, KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMMA, KC_DOT, KC_SLSH, KC_RSFT, MO(_FUNC),
        KC_END,  KC_LCTRL, KC_LALT, KC_NO,   KC_SPACE, KC_SPACE, KC_NO,     KC_RGUI, MO(_MODS)),
