...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
    [_BL] = LAYOUT(
        ...
        KC_LCTL,          KC_LGUI, KC_LALT, KC_SPC ,          KC_SPC ,          KC_SPC , KC_RALT, XXXXXXX, KC_RGUI, TG(2)  ,          KC_RCTL),
   ...
   */
    ...
    [RGB] = LAYOUT(
        ...
        _______,          TG(2), _______, _______,          _______,          _______, _______,   KC_LEFT, KC_UP,   KC_DOWN,          KC_RGHT),
