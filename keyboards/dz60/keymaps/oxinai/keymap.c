...
#define FN_CAPS LT(MO(1), KC_CAPS)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
    [_BL] = LAYOUT(
        ...
        KC_LSFT, XXXXXXX, KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   , KC_N   , KC_M   , KC_COMM, KC_DOT , KC_RSHIFT, KC_UP,          KC_SLSH,
        KC_LCTL,          KC_LGUI, KC_LALT, KC_SPC ,          KC_SPC ,          KC_SPC , MO(MEDIA), MO(RGB), KC_LEFT, KC_DOWN  ,    KC_RGHT),
