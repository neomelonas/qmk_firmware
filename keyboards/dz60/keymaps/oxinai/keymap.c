...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
    [_QWERTY] = LAYOUT_directional(
        ...
        KC_LSFT,         KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSHIFT, KC_UP, KC_FUNC,
        KC_LCTL,   KC_LGUI,  KC_LALT,      KC_NO,  KC_SPC, KC_NO,   KC_RCTRL, KC_RGBL, KC_LEFT, KC_DOWN, KC_RGHT),
   ...
   */
    [_FUNC] = LAYOUT_directional(
        KC_GRV, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, _______, _______, _______, KC_DEL,
        ...
        _______,         KC_MPLY, KC_MPRV, KC_MNXT, _______, _______, _______, KC_MUTE, KC_VOLD, KC_VOLU, _______, _______, KC_PGUP, _______,
        _______,   _______,  _______,      _______,  _______, _______,   KC_RALT, KC_RGBL, KC_MPRV, KC_PGDN, KC_MNXT),
   ...
   * `-----------------------------------------------------------'
   */
    [_RGB] = LAYOUT_directional(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______,     RGB_TOG, RGB_MOD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, _______, _______, _______, _______, _______,
        KC_CAPS,       RGB_STA, RGB_BRE, RGB_RAI, RGB_SWI, RGB_SNA, RGB_KNI, RGB_GRA, _______, _______, _______,      _______,
        _______,         _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_FUNC,
